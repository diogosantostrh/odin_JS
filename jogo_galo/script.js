...
const label_jogador = document.getElementById('jogador'); //pega o label do jogador que usaremos para mostrar qual jogador tem a vez
...
var sortearJogador = function() {
    if(Math.floor(Math.random() * 2)==0) {
        ...
        label_jogador.style.color='#0000ff'; //deixa o texto na cor azul
    }
}
...
var trocarJogador = function() {
    if(jogador=='X') {
        ...
        label_jogador.style.color='#0000ff';
    }
}
